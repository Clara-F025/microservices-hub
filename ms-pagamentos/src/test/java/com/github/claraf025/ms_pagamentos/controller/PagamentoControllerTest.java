...
public class PagamentoControllerTest {
    ...
    void findAllPagamentosShouldReturnListPagamentoDTO() throws Exception {
        ...
        Mockito.when(pagamentoService.getPagamentos()).thenReturn(list);
        ...
        Mockito.verify(pagamentoService).getPagamentos();
    ...
    void findPagamentoByIdShouldReturnPagamentoDTOWhenIdExists() throws Exception {
        ...
        Mockito.when(pagamentoService.getPagamentoById(existingId)).thenReturn(responseDTO);
        ...
        Mockito.verify(pagamentoService).getPagamentoById(existingId);
        Mockito.verifyNoMoreInteractions(pagamentoService);
    }
    ...
    void findPagamentoByIdShouldReturn404WhenIdDoesNotExist() throws Exception {
        ...
        Mockito.when(pagamentoService.getPagamentoById(nonExistingId))
        ...
        Mockito.verify(pagamentoService).getPagamentoById(nonExistingId);
        Mockito.verifyNoMoreInteractions(pagamentoService);
    }
